...
from .mamba_bridge import BridgeLayer4_xb,BridgeLayer3_xb,BridgeLayer2_xb
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, in_channel=1, width=1,
        ...
        self.inplanes = 24 * width
        self.base = int(24 * width)
        self.groups = groups
        ...
        self.xb2 = BridgeLayer2_xb(dims=48)
        self.xb3 = BridgeLayer3_xb(dims=48)
        self.xb4 = BridgeLayer4_xb(dims=48)
    ...
    def forward(self, x):
        ...
        c2 = self.layer1(x)
        c3 = self.layer2(c2)
        c2, c3 = self.xb2([c2, c3])
        c4 = self.layer3(c3)
        c2, c3, c4 = self.xb3([c2,c3,c4])
        c5 = self.layer4(c4)
        c2,c3,c4,c5 = self.xb4([c2,c3,c4,c5])
